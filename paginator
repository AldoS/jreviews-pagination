//jreviews_overrides/views/helpers/paginator.php
	...
	function paginate($params)
	{
		...
		if($this->num_pages > $this->num_pages_threshold)
		{
			...
			$this->return = ($this->current_page != 1 && $this->items_total >= 10) ?
					'<a class="jr-pagenav-prev jrPageActive jrButton jrSmall" title="Μεταβείτε στη πρώτη σελίδα" href="./?pg=1">&#x276E;&#x276E;</a> '
					:
					'<a class="jrPageCurrent jrButton jrSmall jrDisabled" href="'.$url.'">&#x276E;&#x276E;</a> ';
			//end aldo
			
			//aldo //teleia apo kate prin to = shmantikh
			$this->return .= ($this->current_page != 1 && $this->items_total >= 10) ?

				'<a class="jr-pagenav-prev jrPageActive jrButton jrSmall" title="Μεταβείτε στη προηγούμενη σελίδα" href="'.$url.'">'.__t("&#x276E;",true).'</a> '

				:

				'<span class="jrPageCurrent jrButton jrSmall jrDisabled">'.__t("&#x276E;",true).'</span>&nbsp;';
			...
			$this->return .= ($this->current_page != $this->num_pages && $this->items_total >= 10) ?
				...
				'<a class="jr-pagenav-next jrButton jrSmall" title="Μεταβείτε στην επόμενη σελίδα" href="'.$url.'">'.__t("&#x276F;",true).'</a>'
			...
			//aldo
			$this->return .= ($this->current_page != $this->num_pages && $this->items_total >= 10) ?
					'<a class="jr-pagenav-next jrButton jrSmall" title="Μεταβείτε στη τελευταία σελίδα" href="./?pg='.$this->num_pages.'">&#x276F;&#x276F;</a> '
					:
					'<span class="jrPageCurrent jrButton jrSmall jrDisabled">&#x276F;&#x276F;</span>';
			//end aldo
